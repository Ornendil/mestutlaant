...
function skaffListe($aar, $ccl = 'ff=l'){
    global $config;
    ...
    $filename = "cache/".$aar."-".md5($ccl).".json";
    ...
    if (file_exists($filename) && $reload == false) {
        ...
        $restUrl = 'https://'.$config['bibliotek']['underdomene'].'.bib.no/cgi-bin/rest_service/items/1.0/data/'.$ids;
